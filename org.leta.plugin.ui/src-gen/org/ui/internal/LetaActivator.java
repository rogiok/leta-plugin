 ...
 * introduced subclass. 
 */
public class LetaActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(LetaActivator.class);
	...
	private static LetaActivator INSTANCE;
	
	public static final String ORG_LETA = "org.Leta";
	...
	public static LetaActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (ORG_LETA.equals(grammar)) {
			return new org.LetaRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (ORG_LETA.equals(grammar)) {
			return new org.ui.LetaUiModule(this);
		}
